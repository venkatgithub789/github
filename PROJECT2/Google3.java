...
public class Google3 
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		FileInputStream fin = new FileInputStream("d:\\sel_prac\\data.xlsx");   //get the file
		...
		FileOutputStream fout = new FileOutputStream("d:\\sel_prac\\data.xlsx"); //write data into workbook   this will save
		wb.write(fout);
